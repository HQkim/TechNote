...
JDK1.8부터 static 메서드와 default 메서드를 사용할 수 있게 되었음. default 메서드의 목적은 기존 인터페이스의 기능을 확장하며, 구현체에 공통적으로 들어갈 기능(코드)을 default 메서드 내부에서 작성함으로써 구현체에서 반족되는 코드의 작성을 줄여줌
